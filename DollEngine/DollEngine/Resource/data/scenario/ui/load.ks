...
*create_base
[position layer=&sf.layname_menu_base page=fore frame=image021 opacity=255 width=1136 height=640 left=0 top=-10 visible=true]
[current layer=&sf.layname_menu_base page=fore][er]
[nowait]
[locate x=900 y=553]
[button graphic=image029 storage=load.ks target=*return_title cond="tf.is_from_title" enterse=&sf.button_enter clickse=&sf.button_click]
[button graphic=image029 storage=load.ks target=*return_game cond="!tf.is_from_title" enterse=&sf.button_enter clickse=&sf.button_click]
[endnowait]
[return]
...
[locate x=0 y=110]
[button normal=image025 enabled=false]
[eval exp="showsavedata('load',kag.fore.messages[5])"]
[endnowait]
[return]

*load_yes
[eval exp="history_init();"]
[load place=&tf.saveload_index ask=false]
[s]
