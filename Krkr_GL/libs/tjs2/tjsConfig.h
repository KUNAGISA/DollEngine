...
#define TJS_strstr			std::wcsstr
#define TJS_strchr			std::wcschr
...
#define TJS_strncpy_s		wcsncpy_s
    ...
    extern int wnsprintf(wchar_t *buf, unsigned int size, wchar_t *format, ... );
    #define TJS_snprintf wnsprintf
#elif __WIN32__
